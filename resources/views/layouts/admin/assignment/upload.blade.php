            ...
            <div class="section-body">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="submission-table upl table table-borderless mt-5">
                            <tbody>
                                <!-- Submission status -->
                                <tr>
                                    <th scope="row" class="upl">Submission status:</th>
                                    <td><span class="text-success">Submitted for grading</span></td>
                                </tr>
                        
                                <!-- Grading status -->
                                <tr>
                                    <th scope="row" class="upl">Grading status:</th>
                                    <td><span class="text-secondary">Not graded</span></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>Wednesday, 18 September 2024, 9:46 PM</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ asset('assignments/' . $assignment->file) }}">{{ $assignment->file }}</a>
                                        <small class="text-muted">18 September 2024, 9:46 PM</small>
                                    </td>
                                </tr>
